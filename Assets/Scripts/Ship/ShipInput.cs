...
namespace FLFlight {
    ...
    public class ShipInput : MonoBehaviour {
        ...
        [SerializeField] private bool addRoll = true;
        ...
        private void Start () {
            InputManager.gyro.enabled = true;
            InputManager.SetControlScheme("Mobile", PlayerID.One);
        }

        private void Update () {

            strafe = InputManager.GetAxis ("Horizontal");
        ...
        private void SetStickCommandsUsingAutopilot () {
            ...
            // Debug.Log(InputManager.GetAxis("LookVertical"));
            pitch = Mathf.Clamp (InputManager.GetAxis ("LookVertical") * pitchSensitivity, -1f, 1f);
            yaw = Mathf.Clamp (InputManager.GetAxis ("LookHorizontal") * yawSensitivity, -1f, 1f);
            // Debug.Log (gotoPos);
            ...
            BankShipRelativeToUpVector (Camera.main.transform.up);
        ...
        private void BankShipRelativeToUpVector (Vector3 upVector) {
            ...
            float bankInfluence = Mathf.Clamp (InputManager.GetAxis ("LookHorizontal"), -1f, 1f);
