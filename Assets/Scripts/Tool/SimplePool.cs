...
public static class SimplePool {
    ...
    class Pool {
        ...
        public GameObject Spawn (Vector3 pos, Quaternion rot, bool isActive) {
            GameObject obj;
            if (inactive.Count == 0) {
    ...
    /// call that function.
    /// </summary>
    static public GameObject Spawn (GameObject prefab, Vector3 pos, Quaternion rot, bool isActive) {
        Init (prefab);
